...
Rails.application.config.assets.precompile += %w(admin/admin.css admin/admin.js
  ...
  education/management/categories org_search user_education user_education_form
  user_education_search_result ckeditor/filebrowser/images/gal_del.png user_link)
