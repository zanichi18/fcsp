...
function SmartWizard(target, options) {
  ...
  this.buttons = {
    next: $('<div><a href="#" class="buttonNext">' + options.labelNext + '</a></div>').addClass("col-md-3 col-md-offset-6"),
    previous: $('<div><a href="#" class="buttonPrevious">' + options.labelPrevious + '</a></div>').addClass("col-md-3"),
