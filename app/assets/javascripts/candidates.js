    ...
    $(document).on('click', '#btn-apply-job-entry', {}, function(){
      ...
      $.ajax({
        ...
        success: function(){
          ...
          self.removeClass('apply_job button-green')
            .addClass('cancel_apply_job button-white button-light')
          self.text(I18n.t('jobs.candidate.unapply_job'))
        }
      })
    })
  },
  ...
  unapply_job: function() {
    $('body').on('click', '.cancel_apply_job', function() {
      ...
      $.ajax({
        ...
        type: 'DELETE',
        success: function() {
          self.removeClass('cancel_apply_job button-white button-light')
            .addClass('apply_job button-green');
